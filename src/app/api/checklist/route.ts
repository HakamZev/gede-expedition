...
export async function GET() {
  try {
    ...
    // Ubah format array menjadi object key-value agar mudah dibaca di frontend
...
export async function POST(request: Request) {
  try {
    ...
    // Gunakan upsert: jika data kombinasi orang & alat sudah ada maka diupdate, jika belum ada maka dibuat baru
